...
class TestGenerateTfvarsAllModules:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (ResourceType.API_GATEWAY, {"name": "my-api"}),
            (ResourceType.DYNAMODB_TABLE, {"name": "my-table"}),
            (ResourceType.VPC, {"name": "my-vpc"}),
            (ResourceType.SECURITY_GROUP, {"name": "my-sg"}),
            (ResourceType.IAM_ROLE, {"name": "my-role"}),
            (ResourceType.CLOUDWATCH_LOG_GROUP, {"name": "my-logs"}),
            (ResourceType.SNS_TOPIC, {"name": "my-topic"}),
            (ResourceType.SQS_QUEUE, {"name": "my-queue"}),
        ],
    )
